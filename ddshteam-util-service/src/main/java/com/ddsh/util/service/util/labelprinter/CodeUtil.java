...
public class CodeUtil extends LuminanceSource {
    ...
    public CodeUtil(BufferedImage image) {  
        this(image, 0, 0, image.getWidth(), image.getHeight());  
    }  
  
    public CodeUtil(BufferedImage image, int left, int top, int width, int height) {  
        super(width, height);  
    ...
    public LuminanceSource crop(int left, int top, int width, int height) {  
        return new CodeUtil(image, this.left + left, this.top + top, width, height);  
    }  
    ...
    public LuminanceSource rotateCounterClockwise() {  
        ...
        g.dispose();  
        int width = getWidth();  
        return new CodeUtil(rotatedImage, top, sourceWidth - (left + width), getHeight(), width);  
    }  
...
/*    *//** 
    ...
    public static String parseQRCode(String filePath) {  
        ...
        try {  
            ...
            LuminanceSource source = new CodeUtil(image);  
    ...
    public static BufferedImage getCodeImage(String value,int width,int height) throws WriterException
    {
        Hashtable<EncodeHintType, Object> hints = new Hashtable<EncodeHintType, Object>();  
        hints.put(EncodeHintType.CHARACTER_SET, "utf-8");// 指定编码格式  
        hints.put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.L);// 指定纠错等级  
