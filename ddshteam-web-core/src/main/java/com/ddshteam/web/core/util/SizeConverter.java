...
public enum SizeConverter {
    ...
    public static void main(String[] args) {
         System.out.println(SizeConverter.BTrim.convert(1024*1024*1024*1024*1024f));
         System.out.println(SizeConverter.KBTrim.convert(1979120929996f));
         System.out.println(SizeConverter.MBTrim.convert(1979120929996f));
         System.out.println(SizeConverter.GBTrim.convert(1979120929996f));
         System.out.println(SizeConverter.TBTrim.convert(1979120929996f));
