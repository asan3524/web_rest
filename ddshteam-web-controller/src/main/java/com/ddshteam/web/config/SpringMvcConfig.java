...
@Configuration
@Component
//@ImportResource(locations = {/*"file:filestorage/beans.xml", "classpath:filestorage/motan_consumer.xml"*/})
public class SpringMvcConfig extends WebMvcConfigurerAdapter{
    ...
    public void configureMessageConverters(List<HttpMessageConverter<?>> converters) {
        ...
        config.setSerializerFeatures(SerializerFeature.WriteMapNullValue,//保留空的字段
                ...
                SerializerFeature.DisableCircularReferenceDetect);//Number null -> 0
    ...
    public void addInterceptors(InterceptorRegistry registry) {
    	...
    	registry.addInterceptor(new MaliciousRequestInterceptor())
    		.addPathPatterns("/**")
